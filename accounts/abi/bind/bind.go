...
//
// Detailed usage document and tutorial available on the go-aerum Wiki page:
// https://github.com/AERUMTechnology/go-aerum/wiki/Native-DApps:-Go-bindings-to-AERUMTechnology-contracts
package bind
